class Valorant:
    def __init__(self, name, powers, signature,ultimate,fighting_style):
        self.name = name
        self.powers = powers
...
info = Valorant('Jett','Cloudburst, Updraft','Tail Wind',None,'Jett has a agile and evaise fighting style')
